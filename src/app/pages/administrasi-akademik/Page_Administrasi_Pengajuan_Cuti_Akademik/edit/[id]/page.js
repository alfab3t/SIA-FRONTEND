...
export default function EditCutiAkademikPage() {
  ...
  useEffect(() => {
    if (!realId) {
      ...
      router.push("/pages/administrasi-akademik/Page_Administrasi_Pengajuan_Cuti_Akademik");
      return;
    }
      ...
      <form onSubmit={handleSubmit}>
        <div className="row mt-3">
          <div className="col-lg-6">
            <label htmlFor="tahunAjaran" className="form-label">Tahun Akademik *</label>
            <select
              id="tahunAjaran"
        ...
        <div className="row mt-4">
          <div className="col-lg-6">
            <label htmlFor="suratPernyataan" className="form-label">Surat Pernyataan *</label>
            <input
              id="suratPernyataan"
              type="file"
              className="form-control"
          ...
          <div className="col-lg-6">
            <label htmlFor="lampiran" className="form-label">Lampiran (Opsional)</label>
            <input
              id="lampiran"
              type="file"
              className="form-control"

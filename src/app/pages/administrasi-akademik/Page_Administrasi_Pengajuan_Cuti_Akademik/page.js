...
const isAdmin = fixedRole === "ADMIN";
  ...
  const handleAdd = () =>
    router.push("/pages/administrasi-akademik/Page_Administrasi_Pengajuan_Cuti_Akademik/add");

  const handleDetail = (id) =>
    router.push(
      `/pages/administrasi-akademik/Page_Administrasi_Pengajuan_Cuti_Akademik/detail/${encryptIdUrl(
        id
      )}`
    );
  ...
  const handleEdit = (id) =>
    router.push(
      `/pages/administrasi-akademik/Page_Administrasi_Pengajuan_Cuti_Akademik/edit/${encryptIdUrl(
        id
      )}`
    );

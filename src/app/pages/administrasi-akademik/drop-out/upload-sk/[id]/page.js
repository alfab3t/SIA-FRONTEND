...
export default function UploadSKDropOut() {
  ...
  useEffect(() => {
    ...
    if (!role.includes("USER_ADMIN") && !role.includes("ADMIN")) {
      ...
      router.push("/pages/administrasi-akademik/Page_Administrasi_Pengajuan_Drop_Out");
      return;
    }
    ...
    >
      <Card title="Upload SK Drop Out">
        ...
        <div className="row g-3">
          <div className="col-md-6">
            <label htmlFor="noSK" className="form-label fw-bold">
          ...
          <div className="col-md-6">
            <label htmlFor="fileSK" className="form-label fw-bold">
